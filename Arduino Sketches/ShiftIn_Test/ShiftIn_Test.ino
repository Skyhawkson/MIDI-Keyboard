...
//Adapted from Arduino's https://www.arduino.cc/en/Tutorial/ShiftIn
//Designed to use a 4021 shift register
//Make sure you've selected the 16MHz Pro Micro!!!

//Define Pro Micro pins
int dataPin = 7;
int latchPin = 9;
int clockPin = 8;
...
delay(int(1000/64)); //MIDI runs 64 times per second. This should easily be able to handle it.
                     //Bounce does not seem to be a major issue with this timing
